...
WALK
"""
    program.read_output_all()

    for char in spring_code_program[1:]:
        program.read_input(ord(char))

    for i in program.read_output_all():
        if i < 255:
            print(chr(i), end="")
        else:
            return i
...
def main() -> None:
    file_location: str = "python/Advent of Code/2019/Day 21/input.txt"
